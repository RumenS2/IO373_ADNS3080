...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = LL_GPIO_PIN_2|LL_GPIO_PIN_5|LL_GPIO_PIN_6|LL_GPIO_PIN_8; //EC1,sign,EC3,EC4
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = LL_GPIO_PIN_0|LL_GPIO_PIN_1|LL_GPIO_PIN_4|LL_GPIO_PIN_14|LL_GPIO_PIN_15; // a16p a16m MISO(EC2) a38p a38m
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;

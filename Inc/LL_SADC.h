#ifndef __STM32F3xx_LL_SDADC_H
#define __STM32F3xx_LL_SDADC_H
...
#include "stm32f3xx.h"
#include "stddef.h"
#include "stm32f3xx_it.h"  //timer and delay
...
typedef struct
{
  ...
  uint32_t                 *NAhere; //not used at this moment  DMA_HandleTypeDef        *hdma;               /*!< SDADC DMA Handle parameters  */
